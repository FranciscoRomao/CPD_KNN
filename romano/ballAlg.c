...
{   
    ...
    //generates dataset
    //char *args[] = {"ballAlg", "2", "5", "0"};
    pts = get_points(4, argv);
    ...
    //int n_dims = atoi(args[1]); //number of dimensions 
    long n_points = atoi(argv[2]); //number of points in the set
    //long n_points = atoi(args[2]); //number of points in the set
